...
read_length = as.integer(arg_list[3])
flank_trim_length = as.integer(arg_list[4])
splici_dir = arg_list[5]
extra_spliced = arg_list[6]

make_splici_txome(gtf_path, genome_path, read_length, flank_trim_length, splici_dir, extra_spliced)
